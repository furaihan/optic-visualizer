...
export const translations_id: AppTranslations = {
  ...
  limitWarningA: (val, blankVal) => `Lebar lensa (A-Size: ${val}mm) di luar batas standar 35–65mm atau ukuran blank yang dibutuhkan (${blankVal}mm) melebihi batas 80mm.`,
  limitWarningB: (val) => `Tinggi lensa (B-Size: ${val}mm) di luar batas standar 20–55mm atau posisi pupil mata berada di luar bingkai fisiknya.`,
  limitWarningDbl: (val) => `Lebar jembatan hidung (DBL: ${val}mm) di luar standar anatomi wajah manusia 10–28mm.`,
  limitWarningEd: (val, aVal) => `Diameter Efektif (ED: ${val}mm) tidak boleh lebih kecil dari lebar A-Size (${aVal}mm) atau melampaui batas produksi 75mm.`,
  undo: 'Batal',
